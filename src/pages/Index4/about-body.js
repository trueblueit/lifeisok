          ...
          <Col lg="5" className="order-2 order-lg-1">
            <div className="features-box mt-5 mt-lg-0">
              ...
              <p className="text-muted web-desc">
                Life is OK is seeking to provide care support services under the
                National Disability Insurance Scheme (NDIS) in NT, seeking to
                deliver services that includes:
              </p>
              ...
              <ul className="mt-4 features-item-list list-group list-group-flush">
                ...
                <li className="list-group-item">Finding and keeping the job</li>
